...
import { AddToCartButtonFixed } from "@/components/add-to-cart-button-fixed";
...
export function ServiceCardSimple({ service }: ServiceCardProps) {
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div className="mt-auto pt-4 border-t border-white/10">
            ...
            <div className="mt-4 space-y-2" onClick={(e) => e.stopPropagation()}>
              <BuyNowButton service={service} />
              <AddToCartButtonFixed service={service} variant="outline" />
            </div>
          </div>
        </div>
      </div>
